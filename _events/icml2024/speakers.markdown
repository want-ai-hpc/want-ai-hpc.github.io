...
title: Speakers
category: icml2024
permalink: /icml2024/speakers
---

<script>
document.getElementsByClassName('post-title')[0].innerText += " & Panelists"
</script>
...
<div class="row">
  <div class="column">
    <img src="{{site.url}}/assets/urmish.jpg" title="Urmish Thakker" width="63%" />
    <figcaption>
    <details>
    <summary>
  ...
  <div class="column">
    <img src="{{site.url}}/assets/beidi.jpeg" title="Beidi Chen" width="63%" />
    <figcaption>
    <details>
    <summary>
...
<div class="row">
  ...
  <div class="column">
    <img src="{{site.url}}/assets/max.png" title="Max Ryabinin" width="63%" />
    <figcaption>
    <details>
    <summary>
